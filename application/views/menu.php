<div id="menu-container">
	<div class="menu-content-holder">
		...
		<div id="template-menu" class="template-menu">
			...
			<div class="menu-option-holder">
				<?php menu_render('CUSTOMERS',base_url().'customers/',true);?>
				<div class="sub-menu-holder">					  
					<?php submenu_render('CREATE NEW',base_url().'customers/create');?>
					<?php //submenu_render('LIST ALL',base_url().'customers/all');?>					 
				</div>
			</div>
                        <?php endif;?>

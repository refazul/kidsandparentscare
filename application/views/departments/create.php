<div style="width:303px;clear:both;margin:10px auto 20px;">
    ...
    <form action="<?php echo $form['action'];?>" method="POST" id="<?php echo $form['id'];?>">
        ...
        <button style="float:right;margin-top:10px;" id="department_create" class="btn btn-default">Continue</button>
                ...
                $('#<?php echo $form['id'];?>').ajaxForm({
                    ...
                    complete: function(data) {
                        ...
                        if(data.responseJSON.status=='ok')
                            window.location='<?php echo site_url();?>departments/edit/'+data.responseJSON.did;
                        else
                        {
                            ...
                            {
                                $('#msgholder-department_name').parent().css('height','auto');
                                $('#msgholder-department_name').html('').html('Please Give it a Name!').slideDown();
                            }
                        }                        
                    }
                });

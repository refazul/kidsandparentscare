<div style="width:303px;clear:both;margin:10px auto 20px;">
    ...
    <form action="<?php echo $form['action'];?>" method="POST" id="<?php echo $form['id'];?>">
        ...
        <button style="float:right;margin-top:10px;" id="manufacturer_create" class="btn btn-default">Continue</button>
                ...
                $('#<?php echo $form['id'];?>').ajaxForm({
                    ...
                    complete: function(data) {
                        ...
                        if(data.responseJSON.status=='ok')
                            window.location='<?php echo site_url();?>manufacturers/edit/'+data.responseJSON.mid;
                        else
                        {
                            ...
                            {
                                $('#msgholder-manufacturer_name').parent().css('height','auto');
                                $('#msgholder-manufacturer_name').html('').html('Please Give it a Name!').slideDown();
                            }
                        }                        
                    }
                });

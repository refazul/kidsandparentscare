		  ...
		  public function viewPdf2()
        {
            if(user_logged_in() && user_can('GENERATE_REPORT'))
            {
                ...
                //die();
					 ...
					 if($this->input->post('active_2'))$this->db->where('products.department',$this->input->post('filter_2'));
					 if($this->input->post('active_3'))$this->db->where('stocks.sid',$this->input->post('filter_3'));
                ...
                if(sizeof($data['results']>0))
                {
                    ...
                    if($this->input->post('active_2'))$data['file'].='_Dep_'.preg_replace('/[^a-zA-Z0-9]+/', '_', $data['results'][0]['department']);
                    if($this->input->post('active_3'))$data['file'].='_Sup_'.preg_replace('/[^a-zA-Z0-9]+/', '_', $data['results'][0]['supplier']);
                    if($this->input->post('include_cost')!=1)$data['file'].='_without_cost';

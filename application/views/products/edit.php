...
<div style="width:303px;clear:both;margin:10px auto 20px;">
    ...
    <form action="<?php echo $form['action'];?>" method="POST" id="<?php echo $form['id'];?>">
        ...
        if(strlen($sku)==2)
            $sku_offset+=20;
        else if(strlen($sku)==3)
            $sku_offset+=15;
        else if(strlen($sku)==4)
            $sku_offset+=10;
        else if(strlen($sku)==5)
            $sku_offset+=5;
        else if(strlen($sku)==6)
            $sku_offset-=0;
        else if(strlen($sku)==7)
            $sku_offset-=5;
        else if(strlen($sku)==8)
            $sku_offset-=10;
        else if(strlen($sku)==9)
            $sku_offset-=15;
        else if(strlen($sku)==10)
            $sku_offset-=20;
        else if(strlen($sku)==11)
            $sku_offset-=25;
        else if(strlen($sku)==12)
            $sku_offset-=30;
            ...
            <thead>
                <tr>
                    <?php foreach($fields as $key=>$value):?>
                        ...
                        <th style="font-size:10pt;<?php if(isset($value['width']))echo 'width:'.$value['width'].'%';?>"><?php echo $value['title'];?></th>
                    <?php endforeach;?>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <?php foreach($fields as $key=>$field):?>
                        ...
                        <td class="part">
                            <div class="value" style="float:none;">
                                <div class="select-wrap <?php if(isset($field['width_class']))echo $field['width_class'];?>"">
                                    <select name="<?php echo $field['id'];?>">
                                        <?php foreach($field['values'] as $value=>$key):?>

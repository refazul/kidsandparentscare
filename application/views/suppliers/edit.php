<div style="width:303px;clear:both;margin:10px auto 20px;">
    ...
    <form action="<?php echo $form['action'];?>" method="POST" id="<?php echo $form['id'];?>">
        ...
        <button style="float:right;margin-top:10px;" id="supplier_edit" class="btn btn-default">Continue</button>
                ...
                $('#<?php echo $form['id'];?>').ajaxForm({
                    ...
                    complete: function(data) {
                        ...
                        else
                        {
                            ...
                            {
                                $('#msgholder-supplier_active').parent().css('height','auto');
                                $('#msgholder-supplier_active').html('').html('Invalid Value!').slideDown();
                            }
                        }                        
                    }
                });

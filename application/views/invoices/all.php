    ...
    <div class="filter-wrapper" style="clear:right;">
        <div class="select-wrap">
            <select name="filter_by_2" id="filter_by_2">
                <option value="billed_by">Terminal</option>
            </select>
        </div>
    </div>
    <input style="float:right;display:none;margin-right:5px;margin-top:10px;" value="" class='form-control' autocomplete="off" type='text' id='filter_2' name='filter_2'/>

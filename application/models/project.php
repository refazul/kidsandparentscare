...
class Project extends CI_Model
{
    ...
    public function calculate($field, $project)
    {
        ...
        } elseif ($field == 'debit_note_amount') {
    ...
    public function calculate_debit_amount_usd($project)
    {
        ...
        if ($s_c_commission_rate == '') {
            $s_c_commission_rate = 0;
        }
